	...
	jQuery.fn.poptrox = function(options) {
		...
		// Settings
			...
			var settings = jQuery.extend({
					...
					popupWidth:						230,				// Popup width
					popupHeight:					173,				// Popup height
					popupIsFixed:					false,				// If true, popup won't resize to fit images
					usePopupEasyClose:				false,				// If true, popup can be closed by clicking anywhere on the page
                    ...
                    pageChanger:                    null                // (Advanced) Images to change pages
			}, options);
						...
						.fadeTo(settings.fadeSpeed, settings.overlayOpacity, function() {
							...
							if (settings.popupIsFixed)
							{
								...
								img.load(function() {
                                    ...
                                    $(settings.pageChanger).prependTo(_pic);
								});
							}
							else
							{
